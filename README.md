# Diff-Instruct\*: 1-step Text-to-image Models Outperform Flow-matching Models through Score-based RLHF[[Huggingface](https://huggingface.co/XDG-XHS）][[Colab](https://github.com/pkulwj1994/diff_instruct_star/blob/main/distar_1024.ipynb)]
